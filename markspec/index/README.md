...
| `generated`           | string (date-time) |          | Timestamp of index generation                         |
| `project`             | object             |          | Project metadata (global index only)                  |
| `project.name`        | string             | yes      | Canonical reverse-DNS project ID                      |
| `project.domain`      | string             | yes      | Domain abbreviation (e.g., BRK)                       |
| `project.version`     | string             | yes      | Project version string                                |
